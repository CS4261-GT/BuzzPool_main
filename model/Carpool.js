export default class Carpool {
    constructor(departureTime, departureLocation, destination, gtid, requireDriver=true, capacity=5, userGTIDs=[gtid], isTransactionFinished=false, isTripFinished=false) {
